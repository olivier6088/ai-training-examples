...
> **Note** Access to the full documentation [here](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/tuto-streamlit-eda-iris/).
...
![Overview](images/overview-streamlit-eda.png)
